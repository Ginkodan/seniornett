...
import { MessageCircleHeart, MessagesSquare, Newspaper, BookOpen, CloudSun, Tv, Siren, Map, Radio } from 'lucide-react';
...
export const APPS = [
  ...
  { id: 'audio', href: '/audio', icon: <Radio size={36} strokeWidth={2.25} />, label: 'Audio & Musik' },
